...
const CandidateLogin = () => {
    ...
    const generateCaptcha = () => {
        ...
        let newCaptcha = '';
        for (let i = 0; i < 6; i++) { // Increased complexity
            ...
            <form onSubmit={handleSubmit}>
                <div className="form-group mb-4">
                    ...
                    <div className="relative">
                        ...
                        <input type="text" id="c-email-login" name="email" value={loginData.email} onChange={handleChange} required className="w-full pl-10 pr-4 py-2 border border-gray-300 rounded-lg focus:ring-accent-teal focus:border-accent-teal transition" />
                    </div>
                </div>
                ...
                <div className="form-group mb-4">
                    ...
                    <div className="flex items-center space-x-3">
                        ...
                        <motion.button type="button" className="refresh-captcha-btn p-2 bg-accent-teal text-white rounded-full hover:bg-teal-600 transition" onClick={generateCaptcha} whileTap={{ rotate: 360 }}>
                            <FiRefreshCw />
                        </motion.button>
                        <input
                            type="text"
                ...
                <div className="form-links flex justify-between items-center mb-6 text-sm">
                    <p className="text-gray-600">
                        New Account? <Link to="/candidate-signup" className="font-semibold text-accent-teal hover:text-primary-dark transition">Click here</Link>
                    </p>
